...
| Chats | Real browser persistence; staging E2B/OpenRouter answer completed (run 3aaddec6-b657-4274-8fc6-1e3432d930c1, provider cost 18 cents); 968 v1 conversations, 23,179 messages, 21,282 execution records, and 3,673 chat attachments preserved with stable IDs | Complete the wider live follow-up, queue, cancellation, sharing, retry and reconnection matrix |
...
| Migration | Six workspaces; 5,465 issues; 45,725 comments; 60 paused routines; 88,583 archived historical execution records; 968 conversations; 23,179 messages; 8,063 verified attachment files; all source IDs and raw migration records preserved | Adapt and validate each paused routine before activation; convert the legacy webhook to the v2 signed-hook protocol |
